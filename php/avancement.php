  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">ubsbank059@gmail.com</a></i>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <i class="bi bi-list mobile-nav-toggle"></i>
                ...
                <div class="wrapper">
                    <h2> L'etat de cette transaction est a <?php echo $rep2['etat'];?> </h2>
                    <div class=" w2">
                        <ul>
                        ...
                        <h1>Entrez l'etat</h1>
                        <div class="input-box">
                            <input type="text" placeholder="Ex:000-000-000-0" name="etat" value="<?php echo $rep2['etat'];?>" >
                        </div>
            ...
            if(isset($_POST['send'])){
                $etat=$_POST['etat'];
                if(!empty($etat)){
                    $req=$bdd->prepare('UPDATE all_for_one SET etat=:et WHERE code_swift='.$code.'');
                    $req->execute(array(
                        'et'=>$etat
                    ));
                    error('modification terminee!');
